...
<div class="container mx-auto p-4 max-w-2xl">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <div class="px-6 py-5 border-b border-slate-100 bg-slate-50/50 flex items-center gap-3">
            ...
            <div>
                <h2 class="text-lg font-bold text-slate-800">Thêm Cấu hình hiển thị</h2>
                <p class="text-xs text-slate-500 mt-0.5">Thiết lập bố cục chia cột cho câu hỏi và đáp án</p>
            </div>
        </div>

        <form action="{{ route('question-layouts.store') }}" method="POST" class="p-6">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="code" value="{{ old('code', '1x4') }}" 
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="ratio" value="{{ old('ratio', '1.0') }}" min="0.1" max="1.0" step="0.1" 
