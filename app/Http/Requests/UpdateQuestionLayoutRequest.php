...
class UpdateQuestionLayoutRequest extends FormRequest
{
    /**
    ...
    {
        // Lấy ID của Cấu hình đang được sửa
        $layoutId = $this->route('question_layout')->id;

        return [
            'name' => 'required|string|max:255',
            'code' => 'required|string|max:50|unique:question_layouts,code,' . $layoutId,
